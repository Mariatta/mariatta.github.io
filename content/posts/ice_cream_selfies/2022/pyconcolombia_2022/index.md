...
I gave a [keynote speech at PyCon Colombia]({{<ref "posts/talks/theres-an-api-for-that.md">}}). It was an online event,
so I didn't actually get to have ice cream in Colombia. Perhaps one day.

While on a camping trip to Whistler, I decided to get my Ice Cream Selfie at
[Cows Ice cream](https://cows.ca/ice-cream/), which is a favorite place for us. Each time we're there, there's always a
long lineup.
